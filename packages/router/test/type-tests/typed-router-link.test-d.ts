...
interface TestLinkNavMap {
  '/': FileRouteDefinition<'/', 'root'>;
  '/about': FileRouteDefinition<'/about', 'about'>;
  '/users/:userId': FileRouteDefinition<'/users/:userId', 'user'>;
  '/posts/:slug': FileRouteDefinition<'/posts/:slug', 'post'>;
  '/search': FileRouteDefinition<
    '/search',
    'search',
    unknown,
